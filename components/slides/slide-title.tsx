...
export function SlideTitle() {
  return (
    <div className="flex flex-col justify-center h-full p-8 pl-16">
      <h1 className="text-7xl font-bold text-white leading-tight max-w-5xl">
        Build an Agent with Vercel
      </h1>
      <p className="text-2xl max-w-3xl leading-relaxed text-[#a0a0a0] mt-6">
      ...
      <a href="https://x.sather.ws" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-4 mt-16">
        <Image
          src="/headshot.png"
          alt="Will Sather"
          width={56}
