...
export default function AgentMaturitySlide() {
  return (
    <Background>
      <div className="flex h-full flex-col">
        {/* header */}
        <div className="flex items-center gap-4 border-[#242424] border-b px-8 py-6">
          <span className="-rotate-45 font-mono text-2xl text-white">
            -&gt;
          </span>
          <h1 className="font-bold text-3xl text-white">Agentic maturity</h1>
        </div>
        ...
        {/* bottom descriptions */}
        <div className="border-[#242424] border-t">
          {/* titles row */}
          <div className="grid grid-cols-3 border-[#242424] border-b">
            <div className="border-[#242424] border-r px-8 py-6">
              <h2 className="font-bold text-2xl text-white">Assistants</h2>
            </div>
            <div className="border-[#242424] border-r px-8 py-6">
              <h2 className="font-bold text-2xl text-white">Agents</h2>
            </div>
            <div className="px-8 py-6">
              <h2 className="font-bold text-2xl text-white">Autonomous</h2>
            </div>
          </div>
          {/* descriptions row */}
          <div className="grid grid-cols-3 border-[#242424] border-b">
