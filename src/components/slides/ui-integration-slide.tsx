...
export default function UIIntegrationSlide() {
  return (
    <Background>
      <div className="flex h-full flex-col">
        <div className="flex items-center gap-4 border-[#242424] border-b px-8 py-6">
          <h1 className="font-bold text-3xl text-white">Seamless UI integration</h1>
        </div>

        <div className="flex-1 p-8">
          <div className="grid h-full grid-cols-2 gap-8">
            <div className="flex flex-col">
              <h3 className="mb-4 font-semibold text-xl text-white">Backend</h3>
              <div className="flex-1 rounded-lg border border-[#242424] bg-black/40 p-8">
                <pre className="overflow-auto text-base leading-relaxed">
                  <code>
                    <span className="text-[#9ca3af]">// your custom agent</span>
                    {"\n"}
                    ...
                    {"\n"}
                    {"  "}
                    <span className="text-[#9ca3af]">// your implementation</span>
                    {"\n"}
                    <span className="text-[#d4d4d4]">{"}"}</span>
                    {"\n"}
                    {"\n"}
                    <span className="text-[#9ca3af]">// works with createAgentUIStreamResponse</span>
                    {"\n"}
            ...
            <div className="flex flex-col">
              <h3 className="mb-4 font-semibold text-xl text-white">Frontend</h3>
              <div className="flex-1 rounded-lg border border-[#242424] bg-black/40 p-8">
                <pre className="overflow-auto text-base leading-relaxed">
                  <code>
                    <span className="text-[#9ca3af]">// type-safe on the client</span>
                    {"\n"}
                    <span className="text-[#f75f8f]">import</span> <span className="text-[#d4d4d4]">{"{"}</span>{" "}
                    <span className="text-[#52a8ff]">InferAgentUIMessage</span> <span className="text-[#d4d4d4]">{"}"}</span>{" "}
                    ...
                    {"\n"}
                    {"\n"}
                    <span className="text-[#f75f8f]">const</span> <span className="text-[#d4d4d4]">{"{ "}</span>
                    <span className="text-white">messages</span> <span className="text-[#d4d4d4]">{" }"}</span>{" "}
                    <span className="text-[#f75f8f]">=</span> <span className="text-[#c472fb]">useChat</span>
                    <span className="text-[#d4d4d4]">{"<"}</span>
                    <span className="text-[#52a8ff]">MyAgentMessage</span>
                    <span className="text-[#d4d4d4]">{">();"}</span>
                    {"\n"}
                    <span className="text-[#9ca3af]">// full autocomplete and type safety!</span>
                  </code>
                </pre>
              </div>
            </div>
