...
import { anomalyResultSchema } from "@/lib/demo/transaction/anomaly";
import { transactionsTool } from "@/lib/demo/transaction/tools/transactions";
...
4. Use the EXACT transaction ID from the data (e.g., "txn_033" not "33" or "txn-033")
